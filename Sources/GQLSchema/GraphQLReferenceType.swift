...
public protocol GraphQLReferenceType: class, GraphQLValueType {
    var _name:   String         { get }
    var _parent: GraphQLContainerType? { get set }
}

public func ==(lhs: GraphQLReferenceType, rhs: GraphQLReferenceType) -> Bool {
    return lhs === rhs
}

extension GraphQLReferenceType {
